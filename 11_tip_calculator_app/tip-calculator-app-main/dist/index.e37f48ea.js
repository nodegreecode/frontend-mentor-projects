...
var _billView = require("./views/billView");
var _billViewDefault = parcelHelpers.interopDefault(_billView);
var _resultsView = require("./views/resultsView");
var _resultsViewDefault = parcelHelpers.interopDefault(_resultsView);
/* CONTROL METHODS */ const controlBillData = function(data) {
    _model.loadBillData(data);
};
const controlResults = function() {
    const resultsObject = _model.loadResults();
    return resultsObject;
};
/* Listening For Events - SubscruberConsumer Events */ const init = function() {
    (0, _billViewDefault.default).addHandlerBillData(controlBillData);
    (0, _resultsViewDefault.default).addHandlerShowResults(controlResults);
};
init();

},{"./model":"Y4A21","./views/billView":"J3BhN","./views/resultsView":"cSbZE","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"Y4A21":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "state", ()=>state);
parcelHelpers.export(exports, "loadBillData", ()=>loadBillData);
...
const createBillObject = function(data) {
    if (data) state.isActive = true;
    state.bill = data;
};
const calculateTips = function(bill, tips, persons) {};
const loadBillData = function(data) {
...
},{}],"J3BhN":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./View");
var _viewDefault = parcelHelpers.interopDefault(_view);
class BillView extends (0, _viewDefault.default) {
...
exports.default = new BillView();

},{"./View":"5cUXS","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5cUXS":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class View {
    ...
    addHandlerShowResults = function(handler) {
        this._tipsInputs.forEach((tipsInput)=>{
            tipsInput.addEventListener("click", (event)=>{
                ...
                results.isActive ? this._resetButton.classList.remove("disabled") : this._resetButton.classList.add("disabled");
            });
        });
    };
}
